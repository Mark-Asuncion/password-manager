...
pub fn encrypt(key: &[u8], iv: &[u8], data: &String) -> Result<String, ErrorStack> {
...
pub fn decrypt(key: &[u8], iv: &[u8], data_b64: &String) -> Result<String, ErrorStack> {
    let data = base64::decode_block(data_b64.as_str())?;
